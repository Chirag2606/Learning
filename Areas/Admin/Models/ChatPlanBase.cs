namespace Cyara.Web.Portal.Areas.Admin.Models
{
    ...
    public class ChatPlanBase : PlanEditViewModel
    {
        ...
        [Required(ErrorMessage = " ")]
        [Range(0.01F, Plans.Chat.MaxAps, ErrorMessageResourceType = typeof(ValidationMessages), ErrorMessageResourceName = "MaxAps_Invalid")]
        ...
        public override IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (MaxAps > response.Value.MaxChatAps)
            {
                yield return new ValidationResult(
                    ValidationMessages.Plan_MaxApsGreaterThanAccount,
                    new[] { ReflectOn<ChatPlanBase>.GetProperty(p => p.MaxAps).Name });
            }
        }
    }
}